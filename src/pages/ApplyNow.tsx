  ...
  const handleSubmit = () => {
    if (validateStep(currentStep)) {
      ...
      const applicationData = {
        ...
        current_address: formData.addressInfo.currentAddress,
        permanent_address: formData.addressInfo.permanentAddress,
        city: formData.addressInfo.city,
        state: formData.addressInfo.state,
        pincode: formData.addressInfo.pincode,
        residence_type: formData.addressInfo.residenceType,
        years_at_current_address: formData.addressInfo.yearsAtCurrentAddress ? parseInt(formData.addressInfo.yearsAtCurrentAddress) : null,
        employment_type: formData.employmentInfo.employmentType,
        company_name: formData.employmentInfo.companyName,
        designation: formData.employmentInfo.designation,
        work_experience: formData.employmentInfo.workExperience ? parseInt(formData.employmentInfo.workExperience) : null,
        monthly_income: parseInt(formData.employmentInfo.monthlyIncome),
        additional_income: formData.employmentInfo.additionalIncome ? parseInt(formData.employmentInfo.additionalIncome) : 0,
        official_email: formData.employmentInfo.officialEmail,
        office_address: formData.employmentInfo.officeAddress,
        loan_type: formData.loanType,
        loan_amount: parseInt(formData.loanDetails.loanAmount),
        loan_purpose: formData.loanDetails.loanPurpose,
        preferred_tenure: parseInt(formData.loanDetails.preferredTenure),
        existing_loans: formData.loanDetails.existingLoans,
        bank_account: formData.loanDetails.bankAccount,
        ifsc_code: formData.loanDetails.ifscCode,
        application_id: '' // Will be generated by the database
      };

      loanApplicationService.submitApplication(applicationData)
        .then((result) => {
